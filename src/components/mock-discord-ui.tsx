...
import { Cog, Gift, Headphones, HelpCircle, Inbox, Mic, PlusCircle, Pin, Search, Sticker, UserCircle, Video, PlusCircleIcon, Menu, Phone, Smile } from "lucide-react";

export const MockDiscordUi = ({children}:PropsWithChildren) => {
    return(
        <div className="flex min-h-[800px] w-full w-max-[1200px] bg-discord-background rounded-lg overflow-hidden shadow-xl">
            {/* Server list */}
            <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
                ...
                <div className="w-8 h-[2px] bg-discord-brand-color rounded-full my-2"/>
                {[...Array(5)].map((_, i) => (
          <div
            key={i}
          ...
          >
            ...
            <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
                <div className="px-4 h-16 border-b border-[#202225] flex items-center shadow-sm">
                    ...
                    <div className="flex-2 overflow-y-auto pt-4">
                        <div className="px-2 mb-4">
                            ...
                            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcddde] cursor-not-allowed">
                                <Gift className="size-8 mr-4 text-[#b9bbbe]"/>
              ...
              <span className="font-medium">Chime</span>
                    ...
                    <div className="mt-auto p-2 bg-[#292b2f] flex items-center">
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <p className="font-semibold text-white">Chime</p>
          </div>
